...
#define JOINT_MOTOR2_FWD 7
#define JOINT_MOTOR2_REV 8
#define JOINT_MOTOR2_EN 9
#define JOINT_MOTOR2_ADR 0x41

#define JOINT_MOTOR3_FWD 12
#define JOINT_MOTOR3_REV 11
#define JOINT_MOTOR3_EN 13
